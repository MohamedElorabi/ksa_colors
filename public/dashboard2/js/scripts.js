...
///  Add Input
    ...
    $(document).ready(function(){
      var max_filed = 10;
      var wrapper = $(".fund_list");
      var add_button2 = $(".add_button3");
      var z = 1;
      $(add_button2).click(function(e){
        e.preventDefault();
        if(z < max_filed){
          z++;
          $(wrapper).append('<div><input type="text" class="form-control" name="funding_list_right[]" placeholder="" value=""><a href="Javascript:void(0)" class="btn btn-danger remove_filed"><i class="fa fa-minus"></i></a></div>')
        }
