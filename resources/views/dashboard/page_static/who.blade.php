                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @error('image_home')
                                                        <span class=" text-danger">{{$message}}</span>
                                                    @enderror
                                                    <img src="{{asset('uploads/who_page/'.$item->image_home)}}" style="width: 150px" class="image_thumbnail image-preview" alt="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @error('image')
                                                        <span class=" text-danger">{{$message}}</span>
                                                    @enderror
                                                    <img src="{{asset('uploads/who_page/'.$item->image)}}" style="width: 150px" class="image_thumbnail image-preview" alt="">
