...
<head>
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('dashboard')}}/css/vertical-menu.css">
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{asset('dashboard/images/pages/login.png')}}" alt="branding logo">
                                </div>
                                            ...
                                            <div class="card-body pt-1">
                                                <form action="{{ route('admin.login') }}" method="POST">
                                                    ...
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input name="email" type="text" class="form-control" id="user-name" placeholder="البريد الإلكترونى" required>
                                                        <div class="form-control-position">
                                                            <i class="feather icon-user"></i>
                                                        </div>
                                                        <label for="user-name">البريد الإلكترونى</label>
                                                        @if ($errors->has('email'))
