                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @error('logo')
                                                        <span class=" text-danger">{{$message}}</span>
                                                    @enderror
                                                    <img src="{{asset('uploads/genral_setting/'.$item->logo)}}" style="width: 150px" class="image_thumbnail image-preview" alt="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @error('logo_bottom')
                                                        <span class=" text-danger">{{$message}}</span>
                                                    @enderror
                                                    <img src="{{asset('uploads/genral_setting/'.$item->logo_bottom)}}" style="width: 150px" class="image_thumbnail image-preview" alt="">
